...
| Compliance DSR | COPPA/GDPR-K subject rights | -- | `subject_id` on memories, `consent_records`, `dsr_jobs`, `dsr_deletion_tombstones`, `/api/v1/dsr/export`, `/api/v1/dsr/delete`, `/api/v1/dsr/jobs/[id]`, `/api/dsr/jobs`, `/api/dsr/jobs/[jobId]/status`, `/api/cron/dsr-worker`, `/api/v1/audit`, and `/api/v1/audit/export` provide queued subject export, certified deletion, tombstone evidence, and audit evidence. |
