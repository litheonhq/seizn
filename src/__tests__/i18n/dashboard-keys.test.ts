...
const REDESIGN_PATHS = [
  ...
  'dashboard.timeline.loadMore',
  'dashboard.timeline.loadingMore',
  'dashboard.timeline.error',
  'dashboard.timeline.empty.title',
  'dashboard.timeline.empty.body',
  'dashboard.timeline.day.today',
  'dashboard.timeline.day.yesterday',
  'dashboard.timeline.range.window',
  'dashboard.timeline.event.coachAnalysis.label',
  'dashboard.timeline.event.coachAnalysis.group',
  'dashboard.timeline.event.simulationRun.label',
  'dashboard.timeline.event.simulationRun.group',
