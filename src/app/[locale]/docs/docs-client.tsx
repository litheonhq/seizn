      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex gap-12">
        ...
        <nav className="hidden lg:block w-56 shrink-0">
          <div className="sticky top-24 space-y-1">
            ...
            <Link href={`/${locale}/docs/quickstart`} className="block py-1.5 text-sm text-zinc-600 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">{t("docs.sidebar.quickStart")}</Link>
            ...
            <a href="#rate-limits" className="block py-1.5 text-sm text-zinc-600 dark:text-zinc-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">{t("docs.sidebar.rateLimits")}</a>
        ...
        <section id="quickstart" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.quickStart.title")}</h2>
...
curl "https://seizn.com/api/memories?query=user+preferences" \\
  -H "x-api-key: YOUR_API_KEY"`}
        ...
        <section id="authentication" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.authentication.title")}</h2>
          <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
            <p className="text-zinc-700 dark:text-zinc-300 mb-4">
              {t("docs.authentication.description")}{" "}
              <code className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-emerald-600 dark:text-emerald-400">
  ...
  https://seizn.com/api/memories?query=test`}
        ...
        <section id="endpoints" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.endpoints.title")}</h2>
  ...
  "model_used": "haiku"
        ...
        <section id="rate-limits" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.rateLimits.title")}</h2>
          <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
            <table className="w-full">
              ...
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                ...
                <tr>
                  <td className="px-6 py-4 text-zinc-700 dark:text-zinc-300">{t("docs.rateLimits.enterprise")}</td>
          ...
          <p className="mt-4 text-zinc-600 dark:text-zinc-400 text-sm">
            ...
            <code className="px-2 py-1 bg-zinc-200 dark:bg-zinc-800 rounded text-red-500 dark:text-red-400">429 Too Many Requests</code>{" "}
        ...
        <section id="errors" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.errors.title")}</h2>
          <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
            <table className="w-full">
              <thead className="bg-zinc-200 dark:bg-zinc-800">
                <tr>
                  <th className="px-6 py-3 text-left text-sm font-medium text-zinc-700 dark:text-zinc-300">{t("docs.errors.code")}</th>
                  <th className="px-6 py-3 text-left text-sm font-medium text-zinc-700 dark:text-zinc-300">{t("docs.errors.description")}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                <tr>
                  <td className="px-6 py-4"><code className="text-emerald-600 dark:text-emerald-400">200</code></td>
                  <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{t("docs.errors.success")}</td>
                </tr>
                <tr>
                  <td className="px-6 py-4"><code className="text-amber-600 dark:text-amber-400">400</code></td>
                  <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{t("docs.errors.badRequest")}</td>
                </tr>
                <tr>
                  <td className="px-6 py-4"><code className="text-red-600 dark:text-red-400">401</code></td>
                  <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{t("docs.errors.unauthorized")}</td>
                </tr>
                <tr>
                  <td className="px-6 py-4"><code className="text-red-600 dark:text-red-400">429</code></td>
                  <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{t("docs.errors.tooManyRequests")}</td>
                </tr>
                <tr>
                  <td className="px-6 py-4"><code className="text-red-600 dark:text-red-400">500</code></td>
                  <td className="px-6 py-4 text-zinc-600 dark:text-zinc-400">{t("docs.errors.serverError")}</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section id="security" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.security.title")}</h2>
          <div className="space-y-6">
            <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-white mb-4">{t("docs.security.dataSecurityTitle")}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.encryptionAtRest")}</strong> {t("docs.security.encryptionAtRestDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.encryptionInTransit")}</strong> {t("docs.security.encryptionInTransitDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.tenantIsolation")}</strong> {t("docs.security.tenantIsolationDesc")}</span>
                </li>
              </ul>
            </div>

            <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-white mb-4">{t("docs.security.apiKeyManagement")}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.keyRotation")}</strong> {t("docs.security.keyRotationDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.keyExpiration")}</strong> {t("docs.security.keyExpirationDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.usageTracking")}</strong> {t("docs.security.usageTrackingDesc")}</span>
                </li>
              </ul>
            </div>

            <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <h3 className="text-lg font-semibold text-zinc-900 dark:text-white mb-4">{t("docs.security.dataRetention")}</h3>
              <ul className="space-y-3 text-zinc-600 dark:text-zinc-400">
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.export")}</strong> {t("docs.security.exportDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.deletion")}</strong> {t("docs.security.deletionDesc")}</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-emerald-600 dark:text-emerald-400">✓</span>
                  <span><strong className="text-zinc-700 dark:text-zinc-300">{t("docs.security.compliance")}</strong> {t("docs.security.complianceDesc")}</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section id="sdks" className="mb-16">
          <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-6">{t("docs.sdks.title")}</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">{t("docs.sdks.python")}</h3>
              </div>
...
client.extract(conversation="...")`}
            ...
            <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-lg font-semibold text-zinc-900 dark:text-white">{t("docs.sdks.javascript")}</h3>
              </div>
...
function Endpoint({
  ...
  return (
    <div className="mb-8 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
      <div className="p-6 border-b border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center gap-3 mb-3">
          <span className={`px-3 py-1 rounded text-sm font-mono font-bold text-white ${methodColor}`}>
            {method}
          </span>
          <code className="text-lg text-zinc-900 dark:text-white font-mono">{path}</code>
        </div>
          ...
          <div className="space-y-2">
            {Object.entries(requestBody || queryParams || {}).map(([key, value]) => (
              <div key={key} className="flex gap-2">
                <code className="text-emerald-600 dark:text-emerald-400 font-mono">{key}</code>
      ...
      <div className="p-6">
        <h4 className="text-sm font-semibold text-zinc-700 dark:text-zinc-300 mb-3">{responseLabel}</h4>
        <pre className="bg-zinc-200 dark:bg-zinc-800 rounded-lg p-4 overflow-x-auto">
          <code className="text-sm text-zinc-700 dark:text-zinc-300">{responseExample}</code>
        </pre>
      </div>
    </div>
  );
