...
function CopyButton({
  ...
  return (
    <button
      onClick={onCopy}
      className={`${baseClasses} bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-lg transition-all duration-200 flex items-center gap-1.5`}
...
function CodeBlock({
  ...
  return (
    <div className="relative group bg-zinc-900 rounded-lg overflow-hidden">
      ...
      >
        ...
        <div className="shrink-0 mt-1">
          <div className={`w-6 h-6 rounded border-2 transition-colors ${
            isCompleted ? "bg-emerald-500 border-emerald-500" : "border-zinc-600"
          }`}>
            {isCompleted && (
      ...
      <header className="border-b border-zinc-800 sticky top-0 bg-zinc-950/80 backdrop-blur-sm z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-zinc-600">/</span>
            <span className="text-white">{t("docs.tutorialPage.breadcrumb")}</span>
          </div>
          <div className="flex items-center gap-4">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-3 mb-6">
            <span className="px-4 py-1.5 bg-emerald-400/10 text-emerald-400 text-sm font-semibold rounded-full">
              {t("docs.tutorialPage.badge")}
            </span>
            <span className="text-zinc-500">|</span>
            <span className="text-zinc-400 text-sm">{t("docs.tutorialPage.noCreditCard")}</span>
          </div>
        ...
        <div className="mb-10 bg-zinc-900 border border-zinc-800 rounded-xl p-6">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              <span className="text-sm font-medium text-white">{t("docs.tutorialPage.progress")}</span>
              <span className="text-sm text-zinc-400">{completedSteps.size} / 5 {t("docs.tutorialPage.stepsLabel")}</span>
            </div>
        ...
        {progress === 100 && (
          <div className="mt-12 p-8 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-2xl text-center animate-fade-in">
            ...
            <h2 className="text-2xl font-bold text-white mb-3">{t("docs.tutorialPage.completion.title")}</h2>
        ...
        {/* Next Steps */}
        <div className="mt-16">
          <h2 className="text-2xl font-bold text-white mb-6">{t("docs.tutorialPage.nextSteps.title")}</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href={`/${locale}/docs#endpoints`} className="p-6 bg-zinc-900 border border-zinc-800 rounded-xl hover:border-emerald-500/30 transition-all group">
            ...
            <Link href={`/${locale}/docs#sdks`} className="p-6 bg-zinc-900 border border-zinc-800 rounded-xl hover:border-emerald-500/30 transition-all group">
            ...
            <Link href={`/${locale}/docs/faq`} className="p-6 bg-zinc-900 border border-zinc-800 rounded-xl hover:border-emerald-500/30 transition-all group">
