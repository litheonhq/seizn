    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="border-b border-gray-200 sticky top-0 bg-white/80 backdrop-blur-sm z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-zinc-600">/</span>
            <span className="text-gray-900">BYOK</span>
          </div>
          <Link
            href="/dashboard/settings"
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-gray-500 text-sm">Bring Your Own Key</span>
          </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Use Case</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {providers.map((provider) => (
                  <tr key={provider.name}>
                    ...
                    <td className="px-6 py-4 text-gray-500 text-sm">{provider.useCase}</td>
                  </tr>
                ))}
              </tbody>
            </table>
              ...
              <div key={index} className="bg-white border border-gray-200 rounded-xl p-6">
                ...
                {step.action && (
                  <Link
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-gray-900 font-medium rounded-lg transition-colors text-sm ml-12"
                  >
                    {step.action.label}
                ...
                {step.code && (
                  <div className="bg-gray-100 rounded-lg p-4 ml-12 overflow-x-auto">
            ...
            <table className="w-full">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Embedding Cost</th>
                  <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Seizn Fee</th>
                  <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Total</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                <tr>
                  <td className="px-6 py-4 text-gray-900 font-medium">Managed</td>
                  <td className="px-6 py-4 text-gray-500">Included</td>
                  <td className="px-6 py-4 text-gray-500">$0.001/query</td>
                  <td className="px-6 py-4 text-emerald-600 font-medium">$0.001/query</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 text-gray-900 font-medium">BYOK</td>
                  <td className="px-6 py-4 text-gray-500">Your provider rate</td>
                  <td className="px-6 py-4 text-gray-500">$0.0005/query</td>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-gray-900 font-medium mb-2">Can I mix BYOK and Managed?</h3>
              <p className="text-gray-500 text-sm">Yes. Use BYOK for embeddings, Managed for reranking, etc.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-gray-900 font-medium mb-2">Are BYOK queries counted against my Seizn quota?</h3>
              <p className="text-gray-500 text-sm">Yes, API calls count regardless of key source. Only LLM costs differ.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-xl p-6">
              <h3 className="text-gray-900 font-medium mb-2">What happens if my provider key expires?</h3>
              <p className="text-gray-500 text-sm">Queries fail with SEIZN_401 error. Seizn does not fall back automatically.</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center p-8 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-2xl">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready to configure BYOK?</h2>
          <p className="text-gray-500 mb-6">Add your provider keys in the dashboard to get started.</p>
          <Link
            href="/dashboard/settings"
            className="inline-flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-500 text-gray-900 font-medium rounded-lg transition-colors"
          >
            Configure Keys
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
      ...
      <footer className="border-t border-gray-200 py-8">
        <div className="max-w-4xl mx-auto px-6 text-center text-gray-400 text-sm">
          Need help? Contact <a href="mailto:support@seizn.com" className="text-emerald-600 hover:underline">support@seizn.com</a>
        </div>
      </footer>
    </div>
  );
