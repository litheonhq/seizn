    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">{t.errorFormat}</h2>
          <p className="text-gray-600 dark:text-gray-300 mb-4">{t.errorFormatDesc}</p>
...
{`{
  "error": {
    ...
    "docs_url": "https://seizn.com/docs/api/authentication"
        ...
        {/* Getting Help */}
        <div className="mt-12 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-6">
          <h2 className="text-lg font-semibold text-emerald-900 dark:text-emerald-100 mb-2">{t.needHelp}</h2>
