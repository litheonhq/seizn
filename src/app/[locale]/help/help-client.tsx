    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6 text-sm">
            <Link href={`/${locale}/docs`} className="text-gray-600 hover:text-gray-900">
              Docs
            </Link>
      ...
      <section className="bg-gradient-to-b from-emerald-50 to-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{help.title}</h1>
          <p className="text-lg text-gray-600 mb-8">{help.subtitle}</p>
          ...
          <div className="relative max-w-xl mx-auto">
            <input
              ...
              className="w-full px-4 py-3 pl-12 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            />
            <svg
      ...
      <main className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white rounded-2xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">{help.sections.support.title}</h2>
                <p className="text-sm text-gray-500">{help.sections.support.description}</p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">{help.sections.support.email.title}</span>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">{help.sections.support.discord.title}</span>
                </div>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-gray-700">{help.sections.support.github.title}</span>
                </div>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
          ...
          <div className="bg-white rounded-2xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">{help.sections.status.title}</h2>
                <p className="text-sm text-gray-500">{help.sections.status.description}</p>
              </div>
            </div>
            <div className="p-4 rounded-xl bg-emerald-50 border border-emerald-200 mb-4">
              <div className="flex items-center gap-2">
                <div className="w-2.5 h-2.5 bg-emerald-500 rounded-full animate-pulse" />
                <span className="text-sm font-medium text-emerald-700">{help.sections.status.operational}</span>
              </div>
            </div>
            <Link
              href="/status"
              className="flex items-center justify-center gap-2 w-full py-2.5 text-sm font-medium text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors"
            >
          ...
          <div className="bg-white rounded-2xl border p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">{help.sections.billing.title}</h2>
                <p className="text-sm text-gray-500">{help.sections.billing.description}</p>
              </div>
            </div>
            <div className="space-y-2">
              <Link
                ...
                className="flex items-center justify-between p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors"
              >
                <span className="text-sm font-medium text-gray-700">{help.sections.billing.items.plans}</span>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              <Link
                ...
                className="flex items-center justify-between p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors"
              >
                <span className="text-sm font-medium text-gray-700">{help.sections.billing.items.usage}</span>
                <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
        ...
        <div className="bg-white rounded-2xl border p-6 mb-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="font-semibold text-gray-900">{help.sections.docs.title}</h2>
              <p className="text-sm text-gray-500">{help.sections.docs.description}</p>
            </div>
          </div>
          <div className="grid md:grid-cols-5 gap-4">
            <Link
              href={`/${locale}/docs/quickstart`}
              className="flex flex-col items-center p-4 rounded-xl bg-gray-50 hover:bg-emerald-50 hover:border-emerald-200 border border-transparent transition-colors"
            >
              <svg className="w-6 h-6 text-emerald-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
              </svg>
              <span className="text-sm font-medium text-gray-700">{help.sections.docs.links.quickstart}</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">{help.sections.docs.links.apiReference}</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">{help.sections.docs.links.sdks}</span>
            </Link>
            <Link
              href={`/${locale}/docs/limits`}
              className="flex flex-col items-center p-4 rounded-xl bg-gray-50 hover:bg-emerald-50 hover:border-emerald-200 border border-transparent transition-colors"
            >
              ...
              <span className="text-sm font-medium text-gray-700">{help.sections.docs.links.limits}</span>
            </Link>
            <Link
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">{help.sections.docs.links.security}</span>
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border p-6 mb-12">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-gray-900">{help.sections.faq.title}</h2>
                <p className="text-sm text-gray-500">{help.sections.faq.description}</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-emerald-100 mb-6">{help.contact.description}</p>
          <a
            href="mailto:support@seizn.com"
