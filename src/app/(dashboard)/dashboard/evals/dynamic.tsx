  ...
  <div className="space-y-6">
    ...
    <div className="szn-card rounded-lg p-6">
      <div className="animate-pulse flex items-center gap-4">
        <div className="w-12 h-12 rounded-xl bg-[var(--ink-50)]" />
        <div>
          <div className="h-6 w-32 bg-[var(--ink-50)] rounded mb-2" />
          <div className="h-4 w-48 bg-[var(--ink-50)] rounded" />
        </div>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="szn-card rounded-lg p-4">
        <div className="animate-pulse space-y-3">
          <div className="h-5 w-32 bg-[var(--ink-50)] rounded" />
          {[1, 2, 3].map((i) => (
      ...
      <div className="lg:col-span-2 szn-card rounded-lg p-6">
        <div className="animate-pulse">
          <div className="h-6 w-48 bg-[var(--ink-50)] rounded mb-4" />
