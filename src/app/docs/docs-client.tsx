...
import { QuickstartTutorial } from "@/components/docs/QuickstartTutorial";
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex gap-12">
        ...
        <nav className="hidden lg:block w-56 shrink-0">
          <div className="sticky top-24 space-y-1">
            ...
            <a href="#quickstart" className="block py-1.5 text-sm text-emerald-600 font-medium hover:text-emerald-300 transition-colors">{t("docs.sidebar.quickStart")}</a>
