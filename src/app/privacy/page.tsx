...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-[var(--ink-50)]">
      {/* Header */}
      <header className="border-b border-[var(--ink-200)] bg-[var(--ink-50)]/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-[var(--ink-600)] hover:text-[var(--ink-900)] transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        {/* Title Section */}
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-[var(--ink-900)] mb-4">
            Privacy Policy
          </h1>
        ...
        <div className="prose prose-gray prose-lg max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-[var(--ink-900)] mb-6 pb-2 border-b border-[var(--ink-200)]">
          ...
          <section className="mb-12">
            ...
            <p className="text-[var(--ink-600)] leading-relaxed">
              ...
              <a
                ...
                className="text-[var(--ink-900)] hover:text-[var(--ink-900)]/80 underline"
                target="_blank"
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 p-6 bg-[var(--ink-50)] rounded-xl border border-[var(--ink-200)]">
              <p className="text-[var(--ink-900)] font-semibold mb-2">Seizn Privacy Team</p>
        ...
        {/* Footer Navigation */}
        <div className="mt-16 pt-8 border-t border-[var(--ink-200)]">
          <div className="flex flex-wrap gap-6 justify-center text-sm text-[var(--ink-500)]">
            ...
            <Link href="/docs" className="hover:text-[var(--ink-900)] transition-colors">
              Documentation
            </Link>
            <Link href="/status" className="hover:text-[var(--ink-900)] transition-colors">
              System Status
            </Link>
          </div>
          <p className="text-center text-[var(--ink-500)] text-sm mt-6">
