...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-szn-bg">
      {/* Header */}
      <header className="border-b border-szn-border bg-szn-bg/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-szn-text-2 hover:text-szn-text-1 transition-colors"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        {/* Title Section */}
        <div className="mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-szn-text-1 mb-4">
            Privacy Policy
          </h1>
          <p className="text-szn-text-3 text-lg">
        ...
        <div className="prose prose-gray prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-szn-text-2 leading-relaxed mt-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-szn-text-1 mb-6 pb-2 border-b border-szn-border">
              1. Information We Collect
            </h2>

            <h3 className="text-xl font-semibold text-szn-text-1 mt-6 mb-3">
              1.1 Account Information
            </h3>
            <p className="text-szn-text-2 leading-relaxed">
              When you create an account, we collect:
            </p>
            <ul className="list-disc pl-6 mt-3 space-y-2 text-szn-text-2">
              <li>Email address</li>
          ...
          <section className="mb-12">
            ...
            <p className="text-szn-text-2 leading-relaxed">
              ...
              <a
                ...
                className="text-szn-accent hover:text-szn-accent/80 underline"
                target="_blank"
          ...
          <section className="mb-12">
            ...
            <div className="mt-6 p-6 bg-szn-surface rounded-xl border border-szn-border">
              <p className="text-szn-text-1 font-semibold mb-2">Seizn Privacy Team</p>
        ...
        {/* Footer Navigation */}
        <div className="mt-16 pt-8 border-t border-szn-border">
          <div className="flex flex-wrap gap-6 justify-center text-sm text-szn-text-3">
            <Link href="/" className="hover:text-szn-text-1 transition-colors">
              Home
            </Link>
            <Link href="/terms" className="hover:text-szn-text-1 transition-colors">
              Terms of Service
            </Link>
            <Link href="/docs" className="hover:text-szn-text-1 transition-colors">
              Documentation
            </Link>
            <Link href="/status" className="hover:text-szn-text-1 transition-colors">
              System Status
            </Link>
          </div>
          <p className="text-center text-szn-text-3 text-sm mt-6">
