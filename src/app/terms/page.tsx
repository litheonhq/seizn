              ...
              <div className="overflow-x-auto mt-4">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    <tr>
                      <td className="px-4 py-2">Free</td>
                      <td className="px-4 py-2 text-gray-500">10 RPS</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2">Plus</td>
                      <td className="px-4 py-2 text-gray-500">50 RPS</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2">Pro</td>
                      <td className="px-4 py-2 text-gray-500">100 RPS</td>
                    </tr>
                    <tr>
                      <td className="px-4 py-2">Enterprise</td>
                      <td className="px-4 py-2 text-gray-500">Custom</td>
                    </tr>
                  </tbody>
                </table>
              </div>
