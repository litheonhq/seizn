...
export function SnippetTabs({ config, traceId, onShareTrace }: SnippetTabsProps) {
  ...
  return (
    <div className="bg-[var(--ink-900)] rounded-2xl overflow-hidden">
      {/* Tabs */}
        ...
        <div className="flex items-center gap-2">
          ...
          {traceId && onShareTrace && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-[var(--signal-pending-soft)] hover:text-[var(--signal-pending-soft)] bg-[var(--signal-pending)]/10 rounded-lg transition-colors"
            >
