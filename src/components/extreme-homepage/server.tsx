        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/docs" className="text-sm text-gray-500 dark:text-gray-400 hover:text-[color:var(--theme-primary)] transition-colors">{t.extremeHome?.nav?.docs || "Docs"}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <a href="https://github.com/seizn" className="text-sm text-gray-500 dark:text-gray-400 hover:text-[color:var(--theme-primary)] transition-colors inline-flex items-center gap-1.5">
