#!/usr/bin/env python3
"""Update settings-client.tsx with billing tab"""
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    value={profile.email || ""}
                    disabled
                    className="w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">
                {t("dashboard.settingsPage.billingTitle") || "Billing & Quota"}
              </h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                {t("dashboard.settingsPage.billingDesc") || "Manage your subscription and usage limits"}
              </p>
            </div>
              ...
              <>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-medium text-amber-800 dark:text-amber-300">
                          {t("dashboard.settingsPage.quotaWarningTitle") || "Approaching quota limit"}
                        </h4>
                        <p className="text-xs text-amber-700 dark:text-amber-400 mt-1">
                          {t("dashboard.settingsPage.quotaWarningDesc") || "You are approaching your plan limits. Consider upgrading for more capacity."}
                        </p>
                        <Link
                          href="/pricing"
                        ...
                        >
                          {t("dashboard.settingsPage.upgradeNow") || "Upgrade now"}
                ...
                <div className="p-5 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-500 text-white">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm opacity-90">{t("dashboard.settingsPage.currentPlan") || "Current Plan"}</p>
                      <h3 className="text-2xl font-bold capitalize mt-1">{quotaData.plan}</h3>
                      <p className="text-sm opacity-90 mt-1">
                        {t("dashboard.settingsPage.monthlyPrice") || "Monthly"}: {PLAN_LIMITS[quotaData.plan]?.price || "$0"}
                      </p>
                    </div>
                    {quotaData.plan !== "enterprise" && (
                      ...
                      >
                        ...
                        {t("dashboard.settingsPage.upgradePlan") || "Upgrade Plan"}
                      </Link>
                    )}
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <UsageCard
                    title={t("dashboard.settingsPage.memoriesUsage") || "Memories"}
                  ...
                  />
                  <UsageCard
                    title={t("dashboard.settingsPage.apiCallsUsage") || "API Calls"}
                  ...
                  />
                  <UsageCard
                    title={t("dashboard.settingsPage.apiKeysUsage") || "API Keys"}
                ...
                <div className="pt-6 border-t border-gray-200 dark:border-gray-700">
                  <h3 className="text-base font-medium text-gray-900 dark:text-white mb-4">
                    {t("dashboard.settingsPage.planComparison") || "Plan Comparison"}
                  </h3>
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="text-left text-gray-500 dark:text-gray-400 border-b border-gray-200 dark:border-gray-700">
                          <th className="pb-3 font-medium">{t("dashboard.settingsPage.feature") || "Feature"}</th>
                      ...
                      <tbody className="text-gray-700 dark:text-gray-300">
                        <tr className="border-b border-gray-100 dark:border-gray-800">
                          <td className="py-3">{t("dashboard.settingsPage.memoriesLabel") || "Memories"}</td>
                          <td className="py-3">10,000</td>
                          <td className="py-3">100,000</td>
                          <td className="py-3">1,000,000</td>
                          <td className="py-3">{t("dashboard.settingsPage.unlimited") || "Unlimited"}</td>
                        </tr>
                        <tr className="border-b border-gray-100 dark:border-gray-800">
                          <td className="py-3">{t("dashboard.settingsPage.apiCallsLabel") || "API Calls/mo"}</td>
                        ...
                        <tr className="border-b border-gray-100 dark:border-gray-800">
                          <td className="py-3">{t("dashboard.settingsPage.apiKeysLabel") || "API Keys"}</td>
                        ...
                        <tr>
                          <td className="py-3">{t("dashboard.settingsPage.priceLabel") || "Price"}</td>
                          <td className="py-3">$0</td>
                          <td className="py-3">$29/mo</td>
                          <td className="py-3">$99/mo</td>
                          <td className="py-3">{t("dashboard.settingsPage.contactUs") || "Contact Us"}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
    ...
    <div className={`p-4 rounded-xl border ${
      ...
      <div className="flex items-end justify-between mb-2">
        ...
        <span className="text-sm text-gray-500 dark:text-gray-400">
          / {limit === -1 ? (t("dashboard.settingsPage.unlimited") || "Unlimited") : limit.toLocaleString()}
        </span>
      </div>
      {limit !== -1 && (
...
output_path = r"C:\Users\admin\Projects\seizn\src\app\(dashboard)\dashboard\settings\settings-client.tsx"
