...
async function fixAuditFunction() {
  console.log('🔧 Fixing log_audit_event function overload...\n');
  ...
  if (checkError) {
    ...
    console.log('\n⚠️ Cannot execute arbitrary SQL via Supabase client.');
...
`);
    console.log('─'.repeat(60));
    console.log('\n🔗 Supabase SQL Editor: https://supabase.com/dashboard/project/mefsiztbcwknpoqglwmw/sql/new');
    return;
  }
