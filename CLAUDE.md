...
- `REPLAY_BUNDLE_SIGNING_SECRET` is required for trace replay bundle exports.
- Do not fall back to `AUTH_SECRET` / `NEXTAUTH_SECRET`; replay artifacts use a separate signing domain.
